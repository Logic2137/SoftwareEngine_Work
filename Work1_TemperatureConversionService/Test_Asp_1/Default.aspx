<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Test_Asp_1._Default"%>
...
<p> The amount you have deposited:
    ...
    <asp:Button ID="btnCoffee" runat="server" Text="Buy a Coffee" Width="128px" OnClick="btnCoffee_Click" />
<asp:Label ID="lblCoffee" runat="server" Text="()"></asp:Label><br />
    <asp:Button ID="btnRtn" runat="server" Text="Return Deposit" OnClick="btnRtn_Click" />
